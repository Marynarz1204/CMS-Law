...
exports.getCookie = exports.axiosBaseConfig = exports.baseApiUrl = exports.mapObjectToSelect = exports.PInput = exports.Image = exports.getSocialLinkFromList = exports.getPictureUrlFromList = exports.prepareCategoryIcon = exports.prepareSocialIcon = exports.PictureListElement = void 0;
...
var getSocialLinkFromList = function (list) {
    var ret = [];
    if (!list)
        return [];
    for (var i = 0; i < list.length; i++) {
        var element = exports.baseApiUrl + "/GetSocialMediaById/" + list[i];
        ret.push(element);
    }
    return ret;
};
exports.getSocialLinkFromList = getSocialLinkFromList;
