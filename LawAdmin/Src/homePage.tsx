...
export const HomePage = () => {
    ...
    return <PageWrapper>
        ...
        <KeyValueSection _key='box1_link' title='Box 1 link' />
        <KeyValueSection _key='box2' title='Box 2 title content' />
        <KeyValueSection _key='box2_text' title='Box 2 text content' />
        <KeyValueSection _key='box2_link' title='Box 2 link' />
        <KeyValueSection _key='box3' title='Box 3 title content' />
        <KeyValueSection _key='box3_text' title='Box 3 text content' />
        <KeyValueSection _key='box3_link' title='Box 3 link' />
        <KeyValueSection _key='numbers_1' title='Number 1' />
        <KeyValueSection _key='numbers_2' title='Number 2' />
        <KeyValueSection _key='numbers_3' title='Number 3' />
        <KeyValueSection _key='numbers_4' title='Number 4' />
        ...
        <div>
            <form action="" className="section-form" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="buttons-container">
                    <button type='submit' className="btn btn-white btn-sm w-100 mb-0 btn-save" >Saved</button>
                </div>
            </form>
        </div>
    </PageSettingsSection>
