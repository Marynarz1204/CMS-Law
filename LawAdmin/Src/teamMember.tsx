        ...
        <div className="card mb-4">
            ...
            <div className="socials-list">
                <div className="generic-row teammember-row row">
                    ...
                    <div className='text-uppercase text-secondary text-xxs font-weight-bolder opacity-7'>phone number</div>
                    <div className='text-uppercase text-secondary text-xxs font-weight-bolder opacity-7'>email</div>
    ...
    return <form className='section-form' >
        <div className="form-content ">
            <div className="generic-row teammember-row row">
                ...
                <PInput register={{ ...register("phoneNumber") }} inputProps={{ type: 'text' }} />
                <PInput register={{ ...register("email") }} inputProps={{ type: 'text' }} />
                <div>
                    {socialData.length > 0 &&
