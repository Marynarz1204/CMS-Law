...
var PEditor = function (props) {
    ...
    return React.createElement(tinymce_react_1.Editor, __assign({}, register, { apiKey: '7q1598ocz3ty6w4x5kazxikp5t0n7qt0vo4cni0wqhmfol20', onInit: function (evt, editor) { return editorRef.current = editor; }, initialValue: getValues(controlname), onEditorChange: log, init: {
            height: 500,
            menubar: false,
            plugins: [
...
var mapObjectToSelect = function (object, keyLabel, valueLabel, prefix) {
    var retObj = [];
