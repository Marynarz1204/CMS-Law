        ...
        React.createElement("div", { className: "card mb-4" },
            ...
            React.createElement("div", { className: "socials-list" },
                React.createElement("div", { className: "generic-row teammember-row row" },
                    ...
                    React.createElement("div", { className: 'text-uppercase text-secondary text-xxs font-weight-bolder opacity-7' }, "phone number"),
                    React.createElement("div", { className: 'text-uppercase text-secondary text-xxs font-weight-bolder opacity-7' }, "email"),
    ...
    return React.createElement("form", { className: 'section-form' },
        React.createElement("div", { className: "form-content " },
            React.createElement("div", { className: "generic-row teammember-row row" },
                ...
                React.createElement(common_1.PInput, { register: __assign({}, register("phoneNumber")), inputProps: { type: 'text' } }),
                React.createElement(common_1.PInput, { register: __assign({}, register("email")), inputProps: { type: 'text' } }),
